...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoLista( )
    {
    	...
    	{
    		String elemento = cadenasArray[posicion];
    ...
    {
    	NavigableSet<String> revert = arbolCadenas.descendingSet();
    	int tamaño = revert.size();
    	String[] cadenasArray;
    	cadenasArray = new String[tamaño];
        this.arbolCadenas.toArray(cadenasArray);
        List<String> listaCadenas;
    ...
    public String getPrimera( )
    {
    	...
    	{
    		return this.arbolCadenas.ceiling(getPrimera());
    	}
    }
    ...
    public String getUltima( )
    {
    	...
    	{
    		return this.arbolCadenas.floor(getUltima());
    	}
    }
    ...
    {
    	if (this.arbolCadenas.contains(cadena) == false) 
    	{
